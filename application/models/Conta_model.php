...
class Conta_model extends CI_Model
{
    ...
    // CAMPANHA LEADS
    // public function add_campanhas_leads($campanhas_ofertas_data)
    // {
    //     return $this->db->insert('campanhas_ofertas', $campanhas_ofertas_data);
    // }

    // public function get_campanhas_leads($campanhas_ofertas_id)
    // {
    //     $this->db->where('id', $campanhas_ofertas_id);
    //     return $this->db->get('campanhas_ofertas')->row();
    // }

    public function get_campanhas_leads($campanha_tag_id, $campanha_tipo, $limit = null, $start = null)
    {
        $this->db->where('is_deleted', 0);
        $this->db->where('oferta_campanha_id', $campanha_tag_id);
    ...
    public function count_campanhas_leads($campanha_tag_id, $campanha_tipo)
    {
        $this->db->where('is_deleted', 0);
        $this->db->where('oferta_campanha_id', $campanha_tag_id);
    ...
    // public function get_search_campanhas_leads($campanhas_ofertas_id, $f_data, $limit, $start)
    // {
    //   //   if (strlen($f_data['campanhas_ofertas_interacao_tipo']) > 0) {
    //   //       $this->db->where('campanhas_ofertas_status', $f_data['campanhas_ofertas_interacao_tipo']);
    //   //   }
    ...
    // public function count_search_campanhas_leads($campanhas_ofertas_id, $f_data)
    // {
    ...
    // public function update_campanhas_leads($campanhas_ofertas_id, $campanhas_ofertas_data)
    // {
    //     $this->db->where('id', $campanhas_ofertas_id);
    ...
    // public function delete_campanhas_leads($campanhas_ofertas_id)
    // {
    //     $this->db->where('id', $campanhas_ofertas_id);
    //     $campanhas_ofertas_data = array(
    //         'is_deleted' => 1
    ...
    // public function check_campanhas_leads($nome)
    // {
