                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <h6>PRODUTOS xxx <small> (<?= count($this->conta_model->get_produtos()) ?>)</small></h6>
                        </div>
                                        ...
                                        <?php foreach ($produtos as $p) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <button style="background-color:black" onclick="open_modal_update_produto(<?= $p->id ?>)" class="btn btn-link  mb-0">
