                  ...
                  <?php foreach ($campanhas as $t) { ?>
                    ...
                    <tr>
                      ...
                      <div class="d-flex align-items-center justify-content-center">
                          <span class="me-2 text-xs font-weight-bold"><?php echo ( count($this->api_model->dash_get_oferta_concluidas_by_campanha($p->id)) / count($this->api_model->dash_get_demandas_abertas($t->id), 1))?>%</span>
                          <div>
                            <div class="progress">
                              <div class="progress-bar bg-gradient-success" role="progressbar" aria-valuenow="<?php echo ( count($this->api_model->dash_get_oferta_concluidas_by_campanha($p->id)) / count($this->api_model->dash_get_demandas_abertas($t->id), 1))?>" aria-valuemin="0" aria-valuemax="100" style="width: 100%;"></div>
                            </div>
                          </div>
                        </div>
